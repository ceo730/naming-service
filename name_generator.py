...
# 성씨 대표 한자 (SURNAME_STROKES 주석의 한자 목록과 동일 체계)
# 작명 보고서 본문의 한자 화이트리스트 구성 시 사용.
SURNAME_HANJA_CANON = {
    '김': '金', '이': '李', '박': '朴', '최': '崔', '정': '鄭', '강': '姜', '조': '趙',
    '윤': '尹', '장': '張', '임': '林', '한': '韓', '오': '吳', '서': '徐', '신': '申',
    '권': '權', '황': '黃', '안': '安', '송': '宋', '류': '柳', '유': '劉', '전': '全',
    '홍': '洪', '고': '高', '문': '文', '양': '梁', '손': '孫', '배': '裴', '백': '白',
    '허': '許', '남': '南', '심': '沈', '노': '盧', '하': '河', '곽': '郭', '성': '成',
    '차': '車', '주': '朱', '우': '禹', '구': '具', '민': '閔', '나': '羅', '진': '陳',
    '지': '池', '엄': '嚴', '원': '元', '천': '千', '방': '房', '공': '孔', '현': '玄',
    '함': '咸', '변': '卞', '염': '廉', '석': '石', '선': '宣', '설': '薛', '마': '馬',
    '길': '吉', '연': '延', '위': '魏', '표': '表', '명': '明', '기': '奇', '반': '潘',
    '왕': '王', '금': '琴', '옥': '玉', '육': '陸', '인': '印', '맹': '孟', '제': '諸',
    '모': '毛', '탁': '卓', '국': '鞠', '여': '呂', '도': '都', '소': '蘇', '추': '秋',
    '복': '卜', '태': '太', '봉': '奉', '피': '皮', '두': '杜', '감': '甘', '경': '慶',
    '뢰': '賴', '사': '史', '승': '承', '상': '尙', '어': '魚', '은': '殷',
}
