...
# ─── 주요 성씨 획수 사전 ───
SURNAME_STROKES = {
    '김': 8, '이': 7, '박': 6, '최': 12, '정': 9, '강': 11, '조': 10,
    '윤': 12, '장': 11, '임': 6, '한': 15, '오': 4, '서': 8, '신': 9,
    '권': 22, '황': 12, '안': 6, '송': 7, '류': 10, '유': 10, '전': 5,
    '홍': 10, '고': 10, '문': 4, '양': 13, '손': 10, '배': 14, '백': 6,
    '허': 11, '남': 9, '심': 13, '노': 16, '하': 3, '곽': 11, '성': 7,
    '차': 6, '주': 6, '우': 6, '구': 11, '민': 5, '나': 7, '진': 10,
    '지': 6, '엄': 20, '원': 10, '천': 4, '방': 4, '공': 4, '현': 12,
    '함': 12, '변': 16, '염': 20, '석': 5, '선': 6, '설': 11, '마': 10,
    '길': 6, '연': 14, '위': 9, '표': 8, '명': 8, '기': 12, '반': 5,
    '왕': 4, '금': 8, '옥': 5, '육': 6, '인': 2, '맹': 8, '제': 11,
    '모': 4, '탁': 8, '국': 11, '여': 7, '도': 12, '소': 12, '추': 11,
    '복': 14, '태': 4, '봉': 18, '피': 5, '두': 4, '감': 14, '경': 8,
    '뢰': 13, '사': 10, '승': 12, '상': 13, '어': 14, '은': 14,
}
