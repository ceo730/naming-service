...
SURNAME_STROKES = {
    ...
    '허': 11, '남': 9, '심': 8, '노': 16, '하': 9, '곽': 15, '성': 6,
    '차': 7, '주': 6, '우': 9, '구': 8, '민': 12, '나': 20, '진': 16,
    '지': 7, '엄': 20, '원': 4, '천': 3, '방': 8, '공': 4, '현': 5,
    '함': 9, '변': 4, '염': 13, '석': 5, '선': 9, '설': 19, '마': 10,
    '길': 6, '연': 7, '위': 18, '표': 9, '명': 8, '기': 8, '반': 16,
    '왕': 5, '금': 13, '옥': 5, '육': 16, '인': 6, '맹': 8, '제': 16,
    '모': 4, '탁': 8, '국': 17, '여': 7, '도': 16, '소': 22, '추': 9,
