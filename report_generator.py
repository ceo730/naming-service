...
다섯째, 보고서의 주어는 항상 '본 바른이름연구소'입니다. '필자', '제가', '나는' 등 개인을 주어로 쓰지 마십시오. '본 바른이름연구소에서는', '저희 연구소에서는', '저희가' 등 기관 주어를 사용하십시오. 예: "저희 연구소에서 수많은 사주를 분석해왔지만" (O), "제가 25년간 수많은 사주를 봐왔지만" (X).
